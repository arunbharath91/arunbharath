import{a as C}from"./chunk-LF35C3JS.js";import{a as x}from"./chunk-JO3UAMPD.js";import{b}from"./chunk-CBKWYW56.js";import{G as y}from"./chunk-QQYAN4B7.js";import"./chunk-4XKHWIH5.js";import{j as S}from"./chunk-TSF4A7AS.js";import"./chunk-H2UPXF7Z.js";import"./chunk-V5YVYHIU.js";import"./chunk-4MXRPL2I.js";import{Db as g,Eb as u,Jb as o,Kb as i,Lb as a,Mb as n,Xb as h,cb as t,da as s,ic as v,lc as l,nc as p,rb as m,ya as c,zc as f}from"./chunk-DRPAAK6W.js";import"./chunk-EU2KAMEK.js";import"./chunk-DAQOROHW.js";var P={setup:`// app.config.ts
...
}`};var _=()=>["Service","cmp-core","Signal","HTTP"];function L(r,T){r&1&&(i(0,"div",3),n(1,"ui-busy-loader",17),a())}var G=(()=>{class r{constructor(){this.loaderService=s(S),this.loaderState=this.loaderService.loaderState,this.snippets=P,this.isSimulating=c(!1),this.apiProperties=[{name:"loaderState",type:"Signal<LoaderState>",description:"Read-only signal exposing the current loader state ({ showloader: boolean })."},{name:"show()",type:"void",description:"Sets showloader to true, triggering the loading indicator."},{name:"hide()",type:"void",description:"Sets showloader to false, hiding the loading indicator."}],this.interceptorProperties=[{name:"SHOW_LOADING",type:"boolean",default:"false",description:"HTTP context token. Set to true on a request to auto-trigger the loader via loadingInterceptor."}]}simulateLoading(){this.isSimulating()||(this.isSimulating.set(!0),this.loaderService.show(),setTimeout(()=>{this.loaderService.hide(),this.isSimulating.set(!1)},2500))}static{this.\u0275fac=function(d){return new(d||r)}}static{this.\u0275cmp=m({type:r,selectors:[["playground-loader-service-demo"]],decls:20,vars:16,consts:[["title","Loader Service","description","A signal-based global loading state service. Trigger it manually or automatically via the HTTP interceptor.",3,"tags","apiReference","examples"],["demo",""],[1,"demo-loader-wrapper"],[1,"demo-loader-overlay"],[1,"demo-content"],[1,"demo-hint"],[1,"btn","btn-primary",3,"click","disabled"],[1,"demo-state-badge"],[1,"dot"],["api",""],["title","LoaderService Methods & Properties",3,"properties"],["title","HTTP Context Token (loadingInterceptor)",3,"properties"],["examples",""],["title","1. Register the HTTP Interceptor","description","Add loadingInterceptor once in app.config.ts to enable automatic loader triggering on HTTP requests.",3,"code"],["title","2. Manual show / hide","description","Inject LoaderService and call show() / hide() directly for non-HTTP async operations.",3,"code"],["title","3. Automatic via HTTP context","description","Pass SHOW_LOADING: true in the request context \u2014 the interceptor handles show/hide automatically.",3,"code"],["title","4. Read loader state reactively","description","Use the loaderState signal to react to loading changes in your template or component logic.",3,"code"],["type","circle","mode","indeterminate","size","48"]],template:function(d,e){d&1&&(i(0,"playground-demo-page-template",0)(1,"div",1)(2,"div",2),g(3,L,2,0,"div",3),i(4,"div",4)(5,"p",5),l(6,"Click the button to simulate a 2.5s loading state."),a(),i(7,"button",6),h("click",function(){return e.simulateLoading()}),l(8),a(),i(9,"div",7),n(10,"span",8),l(11),a()()()(),i(12,"div",9),n(13,"playground-api-table",10)(14,"playground-api-table",11),a(),i(15,"div",12),n(16,"playground-example-viewer",13)(17,"playground-example-viewer",14)(18,"playground-example-viewer",15)(19,"playground-example-viewer",16),a()()),d&2&&(o("tags",f(15,_))("apiReference",!0)("examples",!0),t(3),u(e.loaderState().showloader?3:-1),t(4),o("disabled",e.isSimulating()),t(),p(" ",e.isSimulating()?"Loading...":"Simulate Loading"," "),t(),v("active",e.loaderState().showloader),t(2),p(" ",e.loaderState().showloader?"Loader is ACTIVE":"Loader is IDLE"," "),t(2),o("properties",e.apiProperties),t(),o("properties",e.interceptorProperties),t(2),o("code",e.snippets.setup),t(),o("code",e.snippets.manualUsage),t(),o("code",e.snippets.httpAutomatic),t(),o("code",e.snippets.readState))},dependencies:[b,C,x,y],styles:[".demo-loader-wrapper[_ngcontent-%COMP%]{position:relative;min-height:200px;border:1px dashed var(--border-color, #dee2e6);border-radius:8px;overflow:hidden}.demo-loader-overlay[_ngcontent-%COMP%]{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:#ffffffbf;z-index:10;-webkit-backdrop-filter:blur(2px);backdrop-filter:blur(2px)}.demo-content[_ngcontent-%COMP%]{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:1.5rem;padding:2.5rem 1.5rem}.demo-hint[_ngcontent-%COMP%]{margin:0;color:var(--text-muted, #6c757d);font-size:.9rem}.demo-state-badge[_ngcontent-%COMP%]{display:flex;align-items:center;gap:.5rem;padding:.4rem 1rem;border-radius:20px;font-size:.8rem;font-weight:600;background:var(--surface-secondary, #f8f9fa);color:var(--text-muted, #6c757d);transition:all .3s ease}.demo-state-badge.active[_ngcontent-%COMP%]{background:#fff3cd;color:#856404}.demo-state-badge.active[_ngcontent-%COMP%]   .dot[_ngcontent-%COMP%]{background:#ffc107;animation:_ngcontent-%COMP%_pulse 1s infinite}.dot[_ngcontent-%COMP%]{width:8px;height:8px;border-radius:50%;background:#adb5bd;transition:background .3s ease}@keyframes _ngcontent-%COMP%_pulse{0%,to{opacity:1;transform:scale(1)}50%{opacity:.5;transform:scale(1.3)}}"],changeDetection:0})}}return r})();export{G as LoaderServiceDemoComponent};
