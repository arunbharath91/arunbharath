import {N}from'./chunk-D_abR2OK.js';import {P}from'./chunk-CdCF1PI4.js';import {h}from'./chunk-BQQP8wzV.js';import {r as rn}from'./chunk-DDeUKt7M.js';import {bA as Gn,bB as Bs,bC as ft,H as He,e as Tt,G as GE,bD as d3,bE as Us,bF as Ap,bG as Zt,_ as SD,N as Ni,m as mT,n as nh,X as Xc,O as vD,av as Ah,a0 as $u,aw as wT,a2 as Uu,bk as Xp,bH as nl,U as Up,b as zT,bI as rl,Y as Yp,Z as Zp,ad as kT,h as hI,R as ID,ax as xh,F as ol,bJ as Mh,a1 as FD,aj as BT,a4 as sT,aH as _T,ak as UT,i as Ch}from'./main-2G52S3VT.js';var Y={basic:`import { TableComponent, ColumnDirective } from '@arun-bharath-ui/cmp-ui';
...
}`;}onSelectionModeChange(a){let l=a==="multi"?Gn.Multi:a==="single"?Gn.Single:Gn.None;this.selectionMode.set(l);}onSelectionChange(a){this.selectedUsers.set(a);}triggerLoading(){this.isLoading.set(true),setTimeout(()=>this.isLoading.set(false),2e3);}onServerPageChange(a){this.serverPage.set(a.pageIndex),this.serverPageSize.set(a.pageSize);}static{this.\u0275fac=function(l){return new(l||s)};}static{this.\u0275cmp=GE({type:s,selectors:[["playground-table-demo"]],decls:86,vars:59,consts:[["bodyCell",""],["title","Table","description","A lightweight, fully-featured data table built with Angular signals \u2014 sorting, pagination, row selection, custom cells, sticky headers and loading states.",3,"tags","apiReference","examples","theming"],["demo",""],[1,"demo-controls"],[3,"change","value"],["value","none"],["value","single"],["value","multi"],["type","checkbox",3,"change","checked"],[1,"demo-btn",3,"click"],[1,"demo-badge"],[3,"selectedChange","data","loading","stickyHeader","selectionMode","maxHeight","pageSize","pageSizeOptions","rowClass","selected"],["uiColumn","","key","id","label","ID","width","60px"],["uiColumn","","key","name","label","Name",3,"sortable"],["uiColumn","","key","email","label","Email",3,"sortable"],["uiColumn","","key","role","label","Role",3,"sortable","align"],["uiColumn","","key","status","label","Status",3,"sortable","align","comparator"],["uiColumn","","key","age","label","Age","width","70px",3,"sortable","align","comparator"],[1,"demo-section"],[1,"demo-section__label"],[3,"currentPageChange","totalItems","pageSize","currentPage"],[1,"demo-heading"],[1,"demo-desc"],[1,"demo-info-box"],[3,"pageChange","data","pageSize","page","totalRecords","pageSizeOptions"],["uiColumn","","key","email","label","Email"],["uiColumn","","key","role","label","Role"],["uiColumn","","key","status","label","Status"],[1,"demo-output"],["api",""],["title","Table Inputs",3,"properties"],["title","Table Outputs",3,"properties"],["title","uiColumn Directive Inputs",3,"properties"],["title","uiColumn Templates",3,"properties"],["title","ui-table-pagination Inputs",3,"properties"],["title","ui-table-pagination Outputs",3,"properties"],["examples",""],["title","Basic table with sorting","description","Minimal setup \u2014 pass data and define columns with the uiColumn directive.",3,"code"],["title","Row selection","description","Single or multi-row selection with two-way [(selected)] binding.",3,"code"],["title","Custom cell templates","description","Use #bodyCell to render badges, buttons, or any custom markup per cell.",3,"code"],["title","Pagination","description","Built-in pagination with configurable page size options.",3,"code"],["title","Loading state","description","Uses an isolated LoaderService instance \u2014 won't trigger the global app loader.",3,"code"],["title","Custom sort comparator","description","Pass a [comparator] function to any sortable column to override the default sort logic \u2014 useful for numeric, date, or priority-based ordering.",3,"code"],["title","Standalone pagination","description","ui-table-pagination can be used independently on any list or grid.",3,"code"],["title","Server-side pagination","description","Pass [totalRecords] to enable server-side mode. The table displays data as-is and uses the server total for page count. Combine with URL query params for page persistence on refresh.",3,"code"],["theming",""],["title","Table CSS Custom Properties",3,"tokens","overrideSnippet"]],template:function(l,e){if(l&1){let R=SD();Ni(0,"playground-demo-page-template",1)(1,"div",2)(2,"div",3)(3,"label"),mT(4," Selection mode: "),Ni(5,"select",4),nh("change",function(p){return e.onSelectionModeChange(p.target.value)}),Ni(6,"option",5),mT(7,"None"),Xc(),Ni(8,"option",6),mT(9,"Single"),Xc(),Ni(10,"option",7),mT(11,"Multi"),Xc()()(),Ni(12,"label")(13,"input",8),nh("change",function(p){return e.stickyHeader.set(p.target.checked)}),Xc(),mT(14," Sticky header "),Xc(),Ni(15,"button",9),nh("click",function(){return e.triggerLoading()}),mT(16," Simulate loading "),Xc(),vD(17,oe,2,1,"span",10),Xc(),Ni(18,"ui-table",11),Ah("selectedChange",function(p){return $u(R),wT(e.selectedUsers,p)||(e.selectedUsers=p),Uu(p)}),Xp(19,12)(20,13)(21,14),nl(22,15),Up(23,ie,3,6,"ng-template",null,0,zT),rl(),nl(25,16),Up(26,re,3,6,"ng-template",null,0,zT),rl(),Xp(28,17),Xc(),Ni(29,"div",18)(30,"p",19)(31,"code"),mT(32,"ui-table-pagination"),Xc(),mT(33),Xc(),Ni(34,"ui-table-pagination",20),Ah("currentPageChange",function(p){return $u(R),wT(e.standalonePage,p)||(e.standalonePage=p),Uu(p)}),Xc()(),Ni(35,"h3",21),mT(36,"Server-Side Pagination"),Xc(),Ni(37,"p",22),mT(38," When "),Ni(39,"code"),mT(40,"[totalRecords]"),Xc(),mT(41," is set, the table enters "),Ni(42,"strong"),mT(43,"server-side mode"),Xc(),mT(44," \u2014 it displays the data as-is (no internal slicing) and uses the total for page count calculation. Each page change triggers a new API call. "),Xc(),Ni(45,"div",23)(46,"strong"),mT(47,"How it works:"),Xc(),mT(48," Pass only the current page's data to "),Ni(49,"code"),mT(50,"[data]"),Xc(),mT(51,", set "),Ni(52,"code"),mT(53,"[totalRecords]"),Xc(),mT(54," to the server's total count, and listen to "),Ni(55,"code"),mT(56,"(pageChange)"),Xc(),mT(57," to fetch the next page. "),Xc(),Ni(58,"ui-table",24),nh("pageChange",function(p){return e.onServerPageChange(p)}),Xp(59,12)(60,13)(61,25)(62,26),nl(63,27),Up(64,le,3,5,"ng-template",null,0,zT),rl(),Xc(),Ni(66,"pre",28),mT(67),Xc()(),Ni(68,"div",29),Yp(69,"playground-api-table",30)(70,"playground-api-table",31)(71,"playground-api-table",32)(72,"playground-api-table",33)(73,"playground-api-table",34)(74,"playground-api-table",35),Xc(),Ni(75,"div",36),Yp(76,"playground-example-viewer",37)(77,"playground-example-viewer",38)(78,"playground-example-viewer",39)(79,"playground-example-viewer",40)(80,"playground-example-viewer",41)(81,"playground-example-viewer",42)(82,"playground-example-viewer",43)(83,"playground-example-viewer",44),Xc(),Ni(84,"div",45),Yp(85,"playground-token-table",46),Xc()();}l&2&&(Zp("tags",kT(56,te))("apiReference",true)("examples",true)("theming",true),hI(5),Zp("value",e.selectionMode()),hI(8),Zp("checked",e.stickyHeader()),hI(4),ID(e.selectedUsers().length>0?17:-1),hI(),Zp("data",e.users)("loading",e.isLoading())("stickyHeader",e.stickyHeader())("selectionMode",e.selectionMode())("maxHeight",e.stickyHeader()?"400px":"")("pageSize",8)("pageSizeOptions",kT(57,ae))("rowClass",e.rowClassFn),xh("selected",e.selectedUsers),hI(2),Zp("sortable",true),hI(),Zp("sortable",true),hI(),Zp("sortable",true)("align",e.ColumnAlign.Center),hI(3),Zp("sortable",true)("align",e.ColumnAlign.Center)("comparator",e.statusComparator),hI(3),Zp("sortable",true)("align",e.ColumnAlign.Right)("comparator",e.ageComparator),hI(5),ol(" used standalone (page ",e.standalonePage()," of 10): "),hI(),Zp("totalItems",100)("pageSize",10),xh("currentPage",e.standalonePage),hI(24),Zp("data",e.serverPageData())("pageSize",e.serverPageSize())("page",e.serverPage())("totalRecords",e.serverTotal)("pageSizeOptions",kT(58,ne)),hI(2),Zp("sortable",true),hI(7),Mh("Page: ",e.serverPage()," | Size: ",e.serverPageSize()," | Total: ",e.serverTotal," | Showing: ",e.serverPageData().length," rows"),hI(2),Zp("properties",e.tableProps),hI(),Zp("properties",e.tableOutputs),hI(),Zp("properties",e.columnProps),hI(),Zp("properties",e.columnTemplates),hI(),Zp("properties",e.paginationProps),hI(),Zp("properties",e.paginationOutputs),hI(2),Zp("code",e.snippets.basic),hI(),Zp("code",e.snippets.selection),hI(),Zp("code",e.snippets.customCell),hI(),Zp("code",e.snippets.pagination),hI(),Zp("code",e.snippets.loading),hI(),Zp("code",e.snippets.customComparator),hI(),Zp("code",e.snippets.standalonePagination),hI(),Zp("code",e.snippets.serverSidePagination),hI(2),Zp("tokens",e.tableTokens)("overrideSnippet",e.tableOverrideSnippet));},dependencies:[rn,P,h,d3,Us,Ap,N,Zt],styles:[".demo-controls[_ngcontent-%COMP%]{display:flex;align-items:center;flex-wrap:wrap;gap:1rem;margin-bottom:1rem}.demo-controls[_ngcontent-%COMP%]   label[_ngcontent-%COMP%]{display:flex;align-items:center;gap:.4rem;font-size:var(--cmp-font-sm);color:var(--cmp-gray-700)}.demo-controls[_ngcontent-%COMP%]   select[_ngcontent-%COMP%]{border:1px solid var(--cmp-gray-300);border-radius:var(--cmp-radius-sm);padding:.25rem .5rem;font-size:var(--cmp-font-sm);background:var(--cmp-white);color:var(--cmp-gray-800)}.demo-btn[_ngcontent-%COMP%]{padding:.35rem .85rem;border:1px solid var(--cmp-primary);border-radius:var(--cmp-radius-sm);background:transparent;color:var(--cmp-primary);font-size:var(--cmp-font-sm);cursor:pointer;transition:background .15s,color .15s}.demo-btn[_ngcontent-%COMP%]:hover{background:var(--cmp-primary);color:var(--cmp-white)}.demo-badge[_ngcontent-%COMP%]{padding:.25rem .65rem;border-radius:var(--cmp-radius-full);background:var(--cmp-primary-soft);color:var(--cmp-primary);font-size:var(--cmp-font-xs);font-weight:var(--cmp-font-semibold)}.badge[_ngcontent-%COMP%]{display:inline-block;padding:.2rem .6rem;border-radius:var(--cmp-radius-full);font-size:var(--cmp-font-xs);font-weight:var(--cmp-font-semibold);white-space:nowrap}.badge--admin[_ngcontent-%COMP%]{background:var(--cmp-danger-soft);color:var(--cmp-danger)}.badge--editor[_ngcontent-%COMP%]{background:var(--cmp-success-soft);color:var(--cmp-success)}.badge--viewer[_ngcontent-%COMP%]{background:var(--cmp-primary-soft);color:var(--cmp-primary)}.badge--manager[_ngcontent-%COMP%]{background:var(--cmp-warning-soft);color:var(--cmp-warning)}.badge--active[_ngcontent-%COMP%]{background:var(--cmp-success-soft);color:var(--cmp-success)}.badge--inactive[_ngcontent-%COMP%]{background:var(--cmp-gray-100);color:var(--cmp-gray-500)}.badge--pending[_ngcontent-%COMP%]{background:var(--cmp-warning-soft);color:var(--cmp-warning)}[_nghost-%COMP%]     .row--inactive{opacity:.55}.demo-section[_ngcontent-%COMP%]{margin-top:1.5rem;border:1px dashed var(--cmp-gray-300);border-radius:var(--cmp-radius-sm);padding:1rem}.demo-section__label[_ngcontent-%COMP%]{font-size:var(--cmp-font-xs);color:var(--cmp-gray-600);margin:0 0 .75rem}.demo-section__label[_ngcontent-%COMP%]   code[_ngcontent-%COMP%]{background:var(--cmp-gray-100);padding:.1rem .35rem;border-radius:var(--cmp-radius-sm);font-size:var(--cmp-font-xs)}.demo-heading[_ngcontent-%COMP%]{font-size:var(--cmp-font-lg, 1.125rem);font-weight:600;color:var(--cmp-gray-900, #111);margin:2rem 0 .5rem}.demo-desc[_ngcontent-%COMP%]{font-size:var(--cmp-font-sm, .875rem);color:var(--cmp-gray-600, #555);margin:0 0 1rem;line-height:1.6}.demo-desc[_ngcontent-%COMP%]   code[_ngcontent-%COMP%]{background:var(--cmp-gray-100, #f3f4f6);padding:2px 6px;border-radius:4px;font-size:.8em}.demo-info-box[_ngcontent-%COMP%]{background:var(--cmp-primary-light, #eef2ff);border-left:4px solid var(--cmp-primary, #6366f1);padding:.75rem 1rem;border-radius:4px;font-size:var(--cmp-font-sm, .875rem);color:var(--cmp-gray-700, #333);margin-bottom:1rem}.demo-info-box[_ngcontent-%COMP%]   strong[_ngcontent-%COMP%]{color:var(--cmp-primary, #6366f1)}.demo-info-box[_ngcontent-%COMP%]   code[_ngcontent-%COMP%]{background:#6366f11a;padding:2px 5px;border-radius:3px}.demo-output[_ngcontent-%COMP%]{margin-top:.75rem;padding:.5rem .75rem;background:var(--cmp-gray-50, #f9fafb);border-radius:4px;font-size:.75rem;font-family:SF Mono,monospace;color:var(--cmp-gray-600, #555)}"]});}}return s})(),k=["Alice Johnson","Bob Smith","Carol White","David Brown","Eva Martinez","Frank Lee","Grace Kim","Henry Wilson"],Z=["Admin","Editor","Viewer","Manager"],ee=["Active","Inactive","Pending"];export{Ce as TableDemoComponent};