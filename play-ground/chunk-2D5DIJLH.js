...
<div class="reviews-list">
  ...
  <ui-comment-list
    ...
    (socialEvent)="handleSocialEvent($event)"
  />
</div>`]),a(7),S("export class CommentsComponent ","{",`
...
@if (saving()) `,"{",`
  <p>Saving...</p>
`,"}"]),a(7),S("export class ReviewsPageComponent ","{",`
...
`,"}"))},dependencies:[w,C],styles:[".comment-demo[_ngcontent-%COMP%]{max-width:900px;margin:0 auto}.comment-demo[_ngcontent-%COMP%]   ui-comment-list[_ngcontent-%COMP%]{display:block;margin-bottom:24px}"]})}}return r})();export{R as CommentListDemoComponent};
