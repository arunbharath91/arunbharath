...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:dn,depthTest:false,depthWrite:false})}function kf(i,e,t){let n=new Float32Array(hi),s=new k(0,1,0);return new kt({name:"SphericalGaussianBlur",defines:{n:hi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:false},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:dn,depthTest:false,depthWrite:false})}function Dc(){return new kt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:dn,depthTest:false,depthWrite:false})}function Nc(){return new kt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:dn,depthTest:false,depthWrite:false})}function Aa(){return `
	...
	`}var Ea=class extends zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=true;let n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new us(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=true;}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Di(5,5,5),r=new kt({name:"CubemapFromEquirect",uniforms:ci(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:It,blending:dn});r.uniforms.tEquirect.value=t;let a=new qt(s,r),o=t.minFilter;return t.minFilter===Wn&&(t.minFilter=Et),new Dr(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=true,n=true,s=true){let r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r);}};function Vf(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,m=false){return h==null?null:m?a(h):r(h)}function r(h){if(h&&h.isTexture){let m=h.mapping;if(m===Ur||m===Fr)if(e.has(h)){let _=e.get(h).texture;return o(_,h.mapping)}else {let _=h.image;if(_&&_.height>0){let M=new Ea(_.height);return M.fromEquirectangularTexture(i,h),e.set(h,M),h.addEventListener("dispose",l),o(M.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){let m=h.mapping,_=m===Ur||m===Fr,M=m===Hn||m===li;if(_||M){let u=t.get(h),f=u!==void 0?u.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==f)return n===null&&(n=new wa(i)),u=_?n.fromEquirectangular(h,u):n.fromCubemap(h,u),u.texture.pmremVersion=h.pmremVersion,t.set(h,u),u.texture;if(u!==void 0)return u.texture;{let b=h.image;return _&&b&&b.height>0||M&&b&&c(b)?(n===null&&(n=new wa(i)),u=_?n.fromEquirectangular(h):n.fromCubemap(h),u.texture.pmremVersion=h.pmremVersion,t.set(h,u),h.addEventListener("dispose",d),u.texture):null}}}return h}function o(h,m){return m===Ur?h.mapping=Hn:m===Fr&&(h.mapping=li),h}function c(h){let m=0,_=6;for(let M=0;M<_;M++)h[M]!==void 0&&m++;return m===_}function l(h){let m=h.target;m.removeEventListener("dispose",l);let _=e.get(m);_!==void 0&&(e.delete(m),_.dispose());}function d(h){let m=h.target;m.removeEventListener("dispose",d);let _=t.get(m);_!==void 0&&(t.delete(m),_.dispose());}function p(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null);}return {get:s,dispose:p}}function Gf(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s=i.getExtension(n);return e[n]=s,s}return {has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent");},get:function(n){let s=t(n);return s===null&&mr("WebGLRenderer: "+n+" extension not supported."),s}}}function Hf(i,e,t,n){let s={},r=new WeakMap;function a(p){let h=p.target;h.index!==null&&e.remove(h.index);for(let _ in h.attributes)e.remove(h.attributes[_]);h.removeEventListener("dispose",a),delete s[h.id];let m=r.get(h);m&&(e.remove(m),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===true&&delete h._maxInstanceCount,t.memory.geometries--;}function o(p,h){return s[h.id]===true||(h.addEventListener("dispose",a),s[h.id]=true,t.memory.geometries++),h}function c(p){let h=p.attributes;for(let m in h)e.update(h[m],i.ARRAY_BUFFER);}function l(p){let h=[],m=p.index,_=p.attributes.position,M=0;if(_===void 0)return;if(m!==null){let b=m.array;M=m.version;for(let E=0,S=b.length;E<S;E+=3){let P=b[E+0],w=b[E+1],R=b[E+2];h.push(P,w,w,R,R,P);}}else {let b=_.array;M=_.version;for(let E=0,S=b.length/3-1;E<S;E+=3){let P=E+0,w=E+1,R=E+2;h.push(P,w,w,R,R,P);}}let u=new(_.count>=65535?os:as)(h,1);u.version=M;let f=r.get(p);f&&e.remove(f),r.set(p,u);}function d(p){let h=r.get(p);if(h){let m=p.index;m!==null&&h.version<m.version&&l(p);}else l(p);return r.get(p)}return {get:o,update:c,getWireframeAttribute:d}}function Wf(i,e,t){let n;function s(p){n=p;}let r,a;function o(p){r=p.type,a=p.bytesPerElement;}function c(p,h){i.drawElements(n,h,r,p*a),t.update(h,n,1);}function l(p,h,m){m!==0&&(i.drawElementsInstanced(n,h,r,p*a,m),t.update(h,n,m));}function d(p,h,m){if(m===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,p,0,m);let M=0;for(let u=0;u<m;u++)M+=h[u];t.update(M,n,1);}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=d;}function Xf(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:Ce("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0;}return {memory:e,render:t,programs:null,autoReset:true,reset:s,update:n}}function qf(i,e,t){let n=new WeakMap,s=new ut;function r(a,o,c){let l=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=d!==void 0?d.length:0,h=n.get(o);if(h===void 0||h.count!==p){let N=function(){x.dispose(),n.delete(o),o.removeEventListener("dispose",N);};h!==void 0&&h.texture.dispose();let _=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,u=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],b=o.morphAttributes.normal||[],E=o.morphAttributes.color||[],S=0;_===true&&(S=1),M===true&&(S=2),u===true&&(S=3);let P=o.attributes.position.count*S,w=1;P>e.maxTextureSize&&(w=Math.ceil(P/e.maxTextureSize),P=e.maxTextureSize);let R=new Float32Array(P*w*4*p),x=new is(R,P,w,p);x.type=tn,x.needsUpdate=true;let A=S*4;for(let T=0;T<p;T++){let U=f[T],H=b[T],q=E[T],D=P*w*4*T;for(let G=0;G<U.count;G++){let O=G*A;_===true&&(s.fromBufferAttribute(U,G),R[D+O+0]=s.x,R[D+O+1]=s.y,R[D+O+2]=s.z,R[D+O+3]=0),M===true&&(s.fromBufferAttribute(H,G),R[D+O+4]=s.x,R[D+O+5]=s.y,R[D+O+6]=s.z,R[D+O+7]=0),u===true&&(s.fromBufferAttribute(q,G),R[D+O+8]=s.x,R[D+O+9]=s.y,R[D+O+10]=s.z,R[D+O+11]=q.itemSize===4?s.w:1);}}h={count:p,texture:x,size:new $e(P,w)},n.set(o,h),o.addEventListener("dispose",N);}if(a.isInstancedMesh===true&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else {let _=0;for(let u=0;u<l.length;u++)_+=l[u];let M=o.morphTargetsRelative?1:1-_;c.getUniforms().setValue(i,"morphTargetBaseInfluence",M),c.getUniforms().setValue(i,"morphTargetInfluences",l);}c.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",h.size);}return {update:r}}function Yf(i,e,t,n,s){let r=new WeakMap;function a(l){let d=s.render.frame,p=l.geometry,h=e.get(l,p);if(r.get(h)!==d&&(e.update(h),r.set(h,d)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===false&&l.addEventListener("dispose",c),r.get(l)!==d&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,d))),l.isSkinnedMesh){let m=l.skeleton;r.get(m)!==d&&(m.update(),r.set(m,d));}return h}function o(){r=new WeakMap;}function c(l){let d=l.target;d.removeEventListener("dispose",c),n.releaseStatesOfObject(d),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor);}return {update:a,dispose:o}}var Zf={[_o]:"LINEAR_TONE_MAPPING",[xo]:"REINHARD_TONE_MAPPING",[vo]:"CINEON_TONE_MAPPING",[yo]:"ACES_FILMIC_TONE_MAPPING",[bo]:"AGX_TONE_MAPPING",[So]:"NEUTRAL_TONE_MAPPING",[Mo]:"CUSTOM_TONE_MAPPING"};function Jf(i,e,t,n,s){let r=new zt(e,t,{type:i,depthBuffer:n,stencilBuffer:s,depthTexture:n?new wn(e,t):void 0}),a=new zt(e,t,{type:fn,depthBuffer:false,stencilBuffer:false}),o=new Dt;o.setAttribute("position",new Xt([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Xt([0,2,0,0,2,0],2));let c=new br({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}function qp(i){let e=[];for(let t in i){let n=i[t];n!==false&&e.push("#define "+t+" "+n);}return e.join(`
...
#define LOW_PRECISION`),e}var jp={[gs]:"SHADOWMAP_TYPE_PCF",[Ni]:"SHADOWMAP_TYPE_VSM"};function em(i){return jp[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var tm={[Hn]:"ENVMAP_TYPE_CUBE",[li]:"ENVMAP_TYPE_CUBE",[_s]:"ENVMAP_TYPE_CUBE_UV"};function nm(i){return i.envMap===false?"ENVMAP_TYPE_CUBE":tm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var im={[li]:"ENVMAP_MODE_REFRACTION"};function sm(i){return i.envMap===false?"ENVMAP_MODE_REFLECTION":im[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var rm={[go]:"ENVMAP_BLENDING_MULTIPLY",[fc]:"ENVMAP_BLENDING_MIX",[pc]:"ENVMAP_BLENDING_ADD"};function am(i){return i.envMap===false?"ENVMAP_BLENDING_NONE":rm[i.combine]||"ENVMAP_BLENDING_NONE"}function om(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return {texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function lm(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,c=em(t),l=nm(t),d=sm(t),p=am(t),h=om(t),m=Xp(t),_=qp(r),M=s.createProgram(),u,f,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Cs).join(`
`)),a=Zo(a),a=Wc(a,t),a=Xc(a,t),o=Zo(o),o=Wc(o,t),o=Xc(o,t),a=qc(a),o=qc(o),t.isRawShaderMaterial!==true&&(b=`#version 300 es
...
`)+`
`+f);let E=b+u+a,S=b+f+o,P=Vc(s,s.VERTEX_SHADER,E),w=Vc(s,s.FRAGMENT_SHADER,S);s.attachShader(M,P),s.attachShader(M,w),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===true&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function R(T){if(i.debug.checkShaderErrors){let U=s.getProgramInfoLog(M)||"",H=s.getShaderInfoLog(P)||"",q=s.getShaderInfoLog(w)||"",D=U.trim(),G=H.trim(),O=q.trim(),$=true,j=true;if(s.getProgramParameter(M,s.LINK_STATUS)===false)if($=false,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,P,w);else {let ce=Hc(s,P,"vertex"),xe=Hc(s,w,"fragment");Ce("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
